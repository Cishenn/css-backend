...
//import com.cishenn.ccs.uitls.SpringContextUtils;
...
//        this.visitorInfoBiz = SpringContextUtils.getBean(IVisitorInfoBiz.class);
//    }
...
////      // 此处和老师不同!!!
//        com.alibaba.fastjson.JSONObject obj = JSON.parseObject(message);
...
////                为这个客服和访客创建一次会话
//                com.cishenn.ccs.entity.Session cs_session = new com.cishenn.ccs.entity.Session();
//                cs_session.setVisitorId(userName);
//                String content = "你好，请问有什么可以帮助你的";
//                cs_session.setContent(content);
//                VisitorInfo visitor = visitorInfoBiz.getOneById(userName);
//                cs_session.setVisitorIp(visitor.getIp());
//                cs_session.setVisitorName(visitor.getName());
//                Servicer customerService = new CustomerService();
...
////                更新客服的会话列表
//                List<com.cishenn.ccs.entity.Session> sessionList = sessionBiz.getSessionList(tempCsId,0,1);
...
////        保存会话消息
//        SessionMsg sessionMsg =  obj.toJavaObject(SessionMsg.class);
//        com.cishenn.ccs.entity.Session ycs_session = new com.cishenn.ccs.entity.Session();
